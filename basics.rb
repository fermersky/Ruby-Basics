...
print (name + a.to_s) # concatination
print "#{name} #{a.to_s}"
# object id's of intances of symbol with equal value have equal object.id, but strings always have different object id
...
puts "let’s go" if hey_ho? # if statement after the code
